      ...
      x.push(
        ...
        >
          ...
          >
            ...
            <option
              value="787c7f"
              style={{ backgroundColor: "#787c7f", color: "#787c7f" }}
            >
              Grey
            </option>
            <option
              value="6ca965"
              style={{ backgroundColor: "#6ca965", color: "#6ca965" }}
            >
              Green
            </option>
            <option
              value="c8b653"
              style={{ backgroundColor: "#c8b653", color: "#c8b653" }}
            >
              yellow
            </option>
          </select>
  ...
  return (
    <div>
      ...
      <div className="instruct">
        {" "}
        You need to slect all colors before I can generate next guess
      </div>
